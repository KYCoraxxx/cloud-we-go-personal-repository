...
type Student struct {
	...
	College string   `thrift:"college,3,required" form:"college,required" json:"college,required"`
	Email   []string `thrift:"email,4,optional" form:"email" json:"email,omitempty"`
	Sex     string   `thrift:"sex,5,required" form:"sex,required" json:"sex,required"`
}
...
type StudentServicePortResult struct {
	Success *PortResp `thrift:"success,0,optional"`
}
